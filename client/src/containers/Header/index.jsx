    ...
    <>
          ...
          <div className="nav">
            <div className="nav-left">
              <ul>
                ...
                {menu &&
                  menu.map((item) => (
                    <TopMenu key={item.banner_seq} topMenu={item} />
                  ))}
              </ul>
            </div>
      ...
      <div class="header-mb">
        ...
        <div id="div-toggle-mb" class="toggle-mb">
          <span class="close-toggle" onclick="closeToggle()">
            x
          </span>
          ...
          <div class="btn-login-toggle">
            <button type="button" class="btn-toggle-group btn-login-mb">
              로그인
            </button>
            <button type="button" class="btn-toggle-group btn-sign-mb">
              회원가입
            </button>
          </div>
          <div class="icon-service-mb">
            <ul>
              <li class="icon-cart-toggle">
                <a href="#">장바구니</a>
              </li>
              <li class="icon-deliver">
                <a href="#">주문/배송</a>
              </li>
              <li class="icon-user">
                <a href="#">마이페이지</a>
          ...
          <div class="list-icon-cate-mb">
            ...
            <ul>
              ...
              <li>
                <a href="#">
                  <img src="images/kids1.png" alt="" />
                </a>
                <p>키즈</p>
              </li>
              <li>
                <a href="#">
                  <img src="images/cutton1.png" alt="" />
                </a>
                <p>커튼</p>
              </li>
              <li>
                <a href="#">
                  <img src="images/lug1.png" alt="" />
                </a>
                <p>러그</p>
              </li>
              <li>
              ...
              <li>
                <a href="#">
                  <img src="images/mattress1.png" alt="" />
                </a>
                <p>매트리스</p>
              </li>
              <li>
                <a href="#">
                  <img src="images/homedeco1.png" alt="" />
                </a>
                <p>홈데코</p>
              </li>
              <li>
              ...
              <li>
                <a href="#">
                  <img src="images/bath1.png" alt="" />
                </a>
                <p>욕실</p>
              </li>
              <li>
                <a href="#">
                  <img src="images/Background copy 1.png" alt="" />
                </a>
                <p>생활용품</p>
              </li>
            </ul>
